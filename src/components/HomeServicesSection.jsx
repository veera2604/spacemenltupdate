...
/* Individual Service Card Component using react-intersection-observer useInView */
function ServiceCardItem({ service }) {
  const navigate = useNavigate();
  const { ref, inView } = useInView({
    threshold: 0.3, // Trigger when 30% of card is visible on screen
    triggerOnce: true,
  });
  ...
  return (
    ...
    >
      ...
      {/* Image Box with Grayscale to Color InView & Desktop Hover */}
