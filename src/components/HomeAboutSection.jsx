...
export default function HomeAboutSection() {
  ...
  return (
    <section id="about-story" className="py-24 sm:py-32 bg-[#f9f8f3] border-y border-gray-200/60 text-[#1A1412]">
      <div className="max-w-7xl mx-auto px-6 md:px-12">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-12 items-center">
          ...
          >
            ...
            <span className="inline-block bg-[#c48b57] text-white px-3.5 py-1 text-xs font-mono uppercase tracking-widest rounded-sm mb-8 font-semibold shadow-sm">
              OUR STORY
            </span>

            {/* Editorial 3-Line Title */}
            <h2 className="font-['Cormorant_Garamond'] text-4xl sm:text-5xl md:text-6xl font-light leading-[1.12] tracking-tight text-[#1A1412] mb-6">
              Built on friendship.
              <br />
            ...
            {/* Sub-Paragraph */}
            <p className="text-gray-600 text-sm sm:text-base leading-relaxed font-normal max-w-sm">
          ...
          >
            <div className="w-full max-w-md aspect-[4/5] overflow-hidden rounded-sm shadow-[0_20px_45px_rgba(0,0,0,0.12)] border border-gray-200/80 bg-gray-900 group">
              <img
          ...
          <motion.div
            ...
            className="lg:col-span-4 flex flex-col items-start"
          >
            <h3 className="font-['Cormorant_Garamond'] text-2xl sm:text-3xl md:text-4xl text-[#c48b57] font-normal mb-3">
              It began around a table.
            </h3>
            <span className="w-12 h-0.5 bg-[#c48b57] mb-6 block" />

            <div className="text-gray-700 text-xs sm:text-sm leading-relaxed space-y-4 font-normal">
