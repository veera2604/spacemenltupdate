      ...
      <div className="max-w-[1850px] 2xl:max-w-[1950px] w-full mx-auto px-6 sm:px-12 md:px-16 lg:px-20 pt-10 sm:pt-14 pb-12 sm:pb-16 flex flex-col lg:flex-row justify-between items-start lg:items-stretch min-h-[300px] gap-12 lg:gap-10">
        ...
        <div className="flex flex-col items-end w-full lg:w-auto mt-6 lg:mt-4 xl:mt-5 gap-6 lg:ml-auto">
          ...
          <button
            ...
            className="flex items-center gap-2.5 bg-[#1A1412] hover:bg-[#c48b57] text-white px-6 py-2.5 rounded-full transition-all duration-300 group shadow-md hover:shadow-lg my-2 lg:my-0 cursor-pointer"
          >
            <svg width="14" height="11" viewBox="0 0 15 12" fill="none" xmlns="http://www.w3.org/2000/svg" className="text-[#c48b57] group-hover:text-white transition-colors">
            ...
            <span className="text-[11px] font-semibold tracking-[0.2em] uppercase mt-0.5">BUILD YOUR VISION</span>
            <svg width="11" height="11" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" className="text-[#c48b57] group-hover:text-white transition-all transform group-hover:translate-x-1 group-hover:-translate-y-1">
